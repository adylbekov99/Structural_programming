...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int distance1 = abs(coor - point1);
        int distance2 = abs(coor - point2);

        if (distance1 < distance2) {
            System.out.println(
                    "The 1st point is the closest one. " +
                            "The distance is " + distance1
            );
        } else if (distance1 > distance2) {
            System.out.println(
                    "The 2nd point is the closest one. " +
                            "The distance is " + distance2
            );
        } else {
            System.out.printf("The distance %d is the same %n",distance1);
        }
    }
}
